...
class DrivetrainNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("FRONT_LEFT_MAGNET_OFFSET", 93)
        self.declare_parameter("FRONT_RIGHT_MAGNET_OFFSET", 866)
        self.declare_parameter("BACK_LEFT_MAGNET_OFFSET", 911)
        self.declare_parameter("BACK_RIGHT_MAGNET_OFFSET", 644)
