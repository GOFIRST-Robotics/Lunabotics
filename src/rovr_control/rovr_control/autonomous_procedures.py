...
async def auto_dig_procedure(node_instance: Node) -> None:
    ...
    await node_instance.cli_digger_read_all.call_async(
        Stop.Request()
    ...
    await node_instance.cli_digger_setPower.call_async(
        SetPower.Request(power=-1 * node_instance.digger_rotation_power)
...
async def auto_offload_procedure(node_instance: Node):
    ...
    if node_instance.apriltagX == 0.0:
        await node_instance.cli_drivetrain_drive.call_async(
            Drive.Request(forward_power=0.0, turning_power=0.3)
    ...
    await node_instance.cli_offloader_setPower.call_async(
        SetPower.Request(power=node_instance.offload_belt_power)
    )  # start offloading
