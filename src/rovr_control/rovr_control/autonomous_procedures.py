...
async def auto_offload_procedure(node_instance: Node):
    ...
    if node_instance.apriltagX == 0.0:
        ...
        print(f"Apriltag found! x: {node_instance.apriltagX}, z: {node_instance.apriltagZ}, yaw :{node_instance.apriltagYaw}")
    ...
    while (node_instance.apriltagZ >= 1.5): # Continue correcting until we are within 1.5 meters of the tag # TODO: Tune this distance
        ...
        print(f"Tracking Apriltag with pose x: {node_instance.apriltagX}, z: {node_instance.apriltagZ}, yaw :{node_instance.apriltagYaw}")
